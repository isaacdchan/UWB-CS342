...
// checks if path is clear in each direction
// if so, moves Creature said direction 
...
// if next location results in dead end,
//     returns creature to previous location and returns "X"
